...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const title = `${m.rooms.st5100.name} – ${m.rooms.st5100.code}`; const desc = m.rooms.st5100.desc; return { title, description: desc, alternates: generateAlternates('monteurzimmer-augsburg/monteurzimmer-augsburg-i-st5-100', locale), openGraph: generateOgMeta(title, desc, 'monteurzimmer-augsburg/monteurzimmer-augsburg-i-st5-100', locale) };
}
